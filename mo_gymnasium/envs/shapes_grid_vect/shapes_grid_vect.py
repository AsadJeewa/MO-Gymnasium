...
class ShapesGridVect(gym.Env, EzPickle):
    """
    ## Description
    ...
    def step(self, action):
        ...
        if action == ShapesGridVect.LEFT:
            col -= 1
        elif action == ShapesGridVect.UP:
            row -= 1
        elif action == ShapesGridVect.RIGHT:
            col += 1
        elif action == ShapesGridVect.DOWN:
            row += 1
        else:
